...
function row(label: string, value: unknown) {
  ...
  return (
    '<tr>' +
      '<td width="180" valign="top" style="padding-top:8px;padding-right:16px;padding-bottom:8px;padding-left:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:18px;color:#66736d;">' +
        esc(label) +
      '</td>' +
...
function estimateLines(record: LeadRecord) {
  ...
  return (
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px;">' +
      '<tr><td style="padding-top:0;padding-right:0;padding-bottom:8px;padding-left:0;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase;color:#8b5a3c;">Estimate breakdown</td></tr>' +
      '<tr><td>' +
  ...
  return (
    ...
    '<html lang="en" dir="ltr">' +
      ...
      '<body style="margin:0;padding:0;background-color:#f5f0e7;">' +
        ...
        '<table role="presentation" lang="en" dir="ltr" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f0e7" style="width:100%;background-color:#f5f0e7;">' +
          '<tr>' +
            '<td align="center" style="padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:10px;">' +
              '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:680px;background-color:#ffffff;border:1px solid #e7dfd0;border-radius:22px;">' +
                ...
                '<tr>' +
                  '<td style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;">' +
                    emailGreeting('Team') +
                    '<div style="padding-top:16px;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase;color:#8b5a3c;">Lead summary</div>' +
                    ...
                    emailButton({ href: crmUrl, label: 'Open in Sales CRM →', marginTop: 24 }) +
                    emailSignature() +
                    '<div style="padding-top:18px;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:18px;color:#66736d;">Replying to this email addresses the client when their email is available. This notification was generated by the Koa’s Events CRM intake pipeline.</div>' +
                  '</td>' +
                '</tr>' +
              '</table>' +
            '</td>' +
        ...
        '<tr><td align="center" style="padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:10px;">' +
          '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:650px;background:#ffffff;border:1px solid #e7dfd0;border-radius:22px;">' +
            ...
            '<tr><td style="padding-top:26px;padding-right:22px;padding-bottom:26px;padding-left:22px;">' +
              ...
              emailSignature() +
              '<div style="padding-top:24px;margin-top:24px;border-top:1px solid #ece7dc;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:18px;color:#66736d;">This is an automatic confirmation that your request reached Koa’s. It is not a booking confirmation or reservation of your date.</div>' +
            '</td></tr>' +
          '</table>' +
        '</td></tr>' +
      '</table>' +
      ...
      '<table role="presentation" lang="en" dir="ltr" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:10px;">' +
        '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:620px;background:#ffffff;border:1px solid #e7dfd0;border-radius:20px;">' +
          ...
          '<tr><td style="padding-top:24px;padding-right:22px;padding-bottom:24px;padding-left:22px;">' +
            emailGreeting('Team') +
            '<div style="font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase;color:#8b5a3c;">Koa’s lead follow-up reminder</div>' +
            ...
            emailButton({ href: crmUrl, label: 'Open lead in CRM →', marginTop: 22 }) +
            emailSignature() +
          '</td></tr>' +
        '</table>' +
      '</td></tr></table>' +
