  ...
  if (match) {
    ...
    if (preset) {
      ...
      const explanation = [
        ...
        'Contract-value basis was ' + (contractValueBasis === 'beforeGet' ? 'before Hawaiʻi GET' : 'after Hawaiʻi GET') + ' at 
...
export const config: Config = { path: '/api/admin/quotes' }; + contractValue.toFixed(2) + ' and was inside this rule’s range.',
        matches.length > 1
