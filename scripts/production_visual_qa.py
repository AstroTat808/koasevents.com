...
def source_mode():
 ...
 profit_requirements={
  ...
  "quarterly profit goal":"quarterlyGrossProfitTarget",
  "annual profit goal":"annualGrossProfitTarget",
  "goal horizon cards":"data-goal-card",
  "availability-aware simulator":"data-mobile-booking-simulator",
  "blackout date settings":"data-staffing-settings-form",
  "bartender availability rows":"data-bartender-availability-rows",
  "editable forecast settings":"data-forecast-settings-form",
  ...
  "drag staffing chip":"dataset.dragBartenderId",
  "calendar assignment saver":"function saveCalendarAssignments",
  "workload warning helper":"function bartenderWorkloadWarnings",
  "bartender workload week input":"dataset.bartenderMaxWeek",
  "bartender workload month input":"dataset.bartenderMaxMonth",
  "bartender performance analytics":"data-bartender-performance-analytics",
  "bartender performance table":"data-bartender-performance-table",
  "bartender pair analytics":"data-bartender-pair-analytics",
  "booking performance rows":"data-booking-performance-rows",
 ...
 for label,needle in {
  ...
  "quarterly target persistence":"quarterlyGrossProfitTarget: number",
  "annual target persistence":"annualGrossProfitTarget: number",
  "forecast weights":"type ForecastWeights",
  "forecast probability persistence":"forecastProbabilities:",
  ...
  "workload limit persistence":"maxEventsPerWeek:",
