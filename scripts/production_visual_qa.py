...
def source_mode():
 ...
 profit_requirements={
  ...
  "capacity-aware booking simulator":"data-mobile-booking-simulator",
  "booking simulator target":"data-booking-sim-target",
  "capacity settings form":"data-capacity-settings-form",
  "forecast scenarios":"data-mobile-forecast-scenarios",
  "editable forecast settings":"data-forecast-settings-form",
  "rolling forecast calibration":"data-rolling-forecast",
  "rolling recommendations action":"data-apply-forecast-recommendations",
 ...
 for label,needle in {
  ...
  "forecast weights type":"type ForecastWeights",
  "forecast probability persistence":"forecastProbabilities:",
  "capacity settings persistence":"bartenderCapacityPerDay:",
