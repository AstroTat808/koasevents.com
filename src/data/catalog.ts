...
export const catalogItems: CatalogItem[] = [
  ...
  },
  {
    ...
    description: 'Upgrade the selected Mobile Bar service level when the event needs a broader beverage-service scope.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Package upgrade',
    keywords: ['mobile bar upgrade', 'bar package upgrade'],
  },
  {
    id: 'venue-additional-hour',
    category: 'services',
    name: 'Additional Venue Hour',
    description: 'Additional approved venue time beyond the package access window, subject to event schedule and staffing availability.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Additional venue hours',
    keywords: ['extra hour', 'venue time', 'overtime'],
  },
  {
    id: 'cake-upgrade',
    category: 'services',
    name: 'Cake Upgrade / Allowance Overage',
    description: 'Cake scope above the amount included or allowed in the selected wedding package.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Cake upgrade',
    keywords: ['cake', 'bakery', 'dessert upgrade'],
  },
  {
    id: 'photo-booth-additional-hour',
    category: 'production',
    name: 'Additional Photo Booth Hour',
    description: 'Additional photo-booth service time beyond the included or quoted service window.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Additional photo booth hours',
    keywords: ['photo booth extra hour', 'photo booth overtime'],
  },
  {
    id: 'decor-upgrade',
    category: 'decor',
    name: 'Premium Décor Upgrade',
    description: 'Additional Koa’s décor inventory or styling scope beyond the selected package.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Décor upgrades',
    keywords: ['decor upgrade', 'premium decor', 'styling'],
  },
  {
    id: 'rental-upgrade',
    category: 'services',
    name: 'Rental Inventory Upgrade',
    description: 'A priced upgrade bundle for additional Koa’s rental inventory beyond the selected package.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Rental upgrades',
    keywords: ['rental upgrade', 'inventory upgrade'],
  },
  {
    id: 'coordination-additional-hour',
    category: 'services',
    name: 'Additional Coordination Hour',
    description: 'Additional coordination time beyond the defined package scope.',
    priceType: 'quote',
    priceLabel: 'Custom quote',
    quantityMode: 'manual',
    quantityLabel: 'Additional coordination hours',
    keywords: ['coordination extra hour', 'planning overtime'],
  },
  {
    id: 'champagne-toast',
    category: 'bar',
